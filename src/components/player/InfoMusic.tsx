...
const InfoMusic = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-start gap-5 md:gap-2 w-full md:basis-[30%]">
      <div className="relative flex items-center justify-center min-w-60 min-h-60 max-w-60 max-h-60 md:min-w-24 md:min-h-24 md:max-w-24 md:max-h-24">
      ...
      <div className="flex items-center md:items-start flex-col justify-center min-h-full">
